...
# ``domain_mlops/resources/model-workflow-resource.yml``
#
# Parameters:
...
dbutils.widgets.text(
    "model_name", "dev.mlops.domain_mlops-model", label="Full (Three-Level) Model Name"
)
...
dbutils.widgets.text(
    ...
    "dev.mlops.trip_dropoff_features",
