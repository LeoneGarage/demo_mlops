...
git add README.md docs .gitignore domain_mlops/resources/README.md
...
* You must be a Databricks workspace admin in the staging and prod workspaces. 
  ...
  [staging workspace admin console](https://demo1.cloud.databricks.com#setting/accounts) and
  [prod workspace admin console](https://demo1.cloud.databricks.com#setting/accounts). 
...
If you want to use different catalog names, please update the target names declared in the[domain_mlops/databricks.yml](../domain_mlops/databricks.yml) file.
...
Follow the instructions in [domain_mlops/resources/README.md](../domain_mlops/resources/README.md) to deploy ML resources
and production jobs.
...
[ML resource config guide](../domain_mlops/resources/README.md)  to propose, test, and deploy
