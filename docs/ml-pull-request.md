...
Opening a pull request will trigger a[workflow](../.github/workflows/domain_mlops-run-tests.yml) 
...
Links:
* [Staging model in UC](https://demo1.cloud.databricks.com/explore/data/models/staging/domain_mlops/domain_mlops-model)
* [Prod model in UC](https://demo1.cloud.databricks.com/explore/data/models/prod/domain_mlops/domain_mlops-model)
. 
